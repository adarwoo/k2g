...
pub fn JobSidebar(state: Signal<AppCtx>) -> Element {
    ...
    let board_thickness_pcb_label = snapshot.board.as_ref().and_then(|board| board.thickness.as_ref()).map(
        |thickness| unit_service::format_length_display(Length::from_mm(thickness.as_mm()), snapshot.unit_system),
    );
                        ...
                        if let Some(active_profile) = snapshot.selected_process_profile() {
                            div { class: "field",
                                ...
                                if active_profile.cut_depth_strategy == CutDepthStrategy::MultiPass {
                                    p { class: "diag-status",
                                        "Max depth/pass: {unit_service::format_length_display(active_profile.multi_pass_max_depth, snapshot.unit_system)}"
                                    }
                                }
                                p { class: "diag-status",
                        ...
                        div { class: "field",
                            ...
                            input {
                                ...
                                oninput: move |evt| {
                                    ...
                                    crate::ui::app::mutate_ctx(state, |s| s.project_config.rotation_angle = value);
                                },
                            }
                        }
                                ...
                                div { class: "field section-subfield",
                                    ...
                                    input {
                                        ...
                                        oninput: move |evt| {
                                            ...
                                            crate::ui::app::mutate_ctx(state, |s| s.project_config.tab_count = value);
                                        },
                                    }
                                }
                                        ...
                                        label { class: "checkbox-line",
                                            input {
                                                ...
                                                oninput: move |evt| {
                                                    ...
                                                    crate::ui::app::mutate_ctx(state, |s| s.project_config.mouse_bites_enabled = enabled);
                                                },
                                            }
